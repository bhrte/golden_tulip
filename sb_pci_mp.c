...
#else
static inline void __mp_put_char(struct sb_uart_port *port, struct circ_buf *circ, unsigned char c);
static void mp_put_char(struct tty_struct *tty, unsigned char ch);
#endif

static void mp_put_chars(struct tty_struct *tty);
#if (LINUX_VERSION_CODE < KERNEL_VERSION(2,6,10))
static int mp_write(struct tty_struct *tty, int from_user, const unsigned char * buf, int count);
#else
...
#else
static void multi_interrupt(int irq, void *dev_id, struct pt_regs *regs);
#endif
...
static struct pci_device_id golden_tulip_pci_tbl[] = {
    { PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP1,
      PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP1, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP2,
      PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP2, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP4,
      PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP4, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP4A,
      PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP4A, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP6,
      PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP6, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP6A,
      PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP6A, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP8,
      PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP8, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP32,
      PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP32, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP1P,
      PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP1P, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP2S1P,
      PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP2S1P, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP1,
      PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP1, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP2,
      PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP2, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP4,
      PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP4, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP8,
      PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP8, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP32,
      PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP32, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP1E,
      PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP1E, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP2E,
      PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP2E, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP2B,
      PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP2B, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP4B,
      PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP4B, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP8B,
      PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_MP8B, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_GT_MP4,
      PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_GT_MP4, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_GT_MP4A,
      PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_GT_MP4A, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_GT_MP6,
      PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_GT_MP6, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_GT_MP6A,
      PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_GT_MP6A, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_GT_MP8,
      PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_GT_MP8, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_GT_MP32,
      PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_GT_MP32, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_GT_MP1,
      PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_GT_MP1, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_GT_MP2,
      PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_GT_MP2, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_GT_MP4,
      PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_GT_MP4, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_GT_MP8,
      PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_GT_MP8, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_GT_MP32,
      PCI_VENDOR_ID_MULTIPORT, PCIE_DEVICE_ID_GT_MP32, 0, 0, 0 },
    { PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP4M,
      PCI_VENDOR_ID_MULTIPORT, PCI_DEVICE_ID_MP4M, 0, 0, 0 }, /* modem */
    { 0, } /* terminate list */
};
MODULE_DEVICE_TABLE(pci,golden_tulip_pci_tbl);
